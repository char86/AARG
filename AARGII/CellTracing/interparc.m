...
CancelLine = '';
%CG: 22.1.17; CancelLine triggers interparc to do nothing. Empty outputs
%from interparc will cause the calling function to cancel the current line.
...
if strcmp(CancelLine, 'abort')
    pt = [];
    dudt = [];
    fofthandle = [];
    
elseif ~strcmp(CancelLine, 'abort')
